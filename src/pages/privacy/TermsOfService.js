  ...
  return (
    <div className={styles.container}>
      ...
      <p>
        ...
        you, whether personally or on behalf of an entity ("you") and StockUp
        doing business as StockUp ("StockUp," "we," "us," or "our"), concerning
        your access to and use of the{' '}
        <a href="https://stockupfinance.app" alt="Stock Up Homepage">
        ...
        EXPRESSELY PROHIBITED FROM USING THE SITE AND YOU MUST DISCONTINUE USE
        IMMEDIATAELY.
      </p>
      <p>
        ...
        We will alert you about changes by updating the "Last updated" date of
        ...
        every time you use our Site so that you can understand which Terms
      ...
      <p>
        ...
        soley responsible for compliance with local laws, if and to the extent
        local laws are applicable.
      </p>
      <p>
        The Site is not tailored to comply with industry-specific regulations
        (Health Insurance Portability and Accountability Act (HIPPA), Federal
      ...
      <p>
        ...
        under the agae of 18 are not permitted to use or register for the Site.
      </p>
      <h2>2. INTELLECTUAL PROPERTY RIGHTS</h2>
      <p>
        Unless otherwise indicated, the Site is our propietary property and all
        ...
        these Terms of Use, no part of the Site, no Content or Marks may be
      ...
      <p>
        ...
        limited licesnse to acces the Site and to download or print a copy of
      ...
      <p>
        ...
        infomration you submit will be true, accurate, current, and complete;
        ...
        not access the Site through automated or non-human means, weather
        through a bot, script, or otherwise; (6) you will not use the Site for
        any illegal or unauthorized prupose; and (7) your use of the Site will
      ...
      <ul>
        <li>
          ...
          or compete, directly or indirectly, a collection, compilation,
          database, or directory without written permission from us.
        </li>
        <li>
          Trick, defraud, or mislead us and other users, especially in any
          attemp to learn sensitive information such as user passwords.
        </li>
        <li>
          Circumvent, disable, or otherwise interefere with secruity-related
      ...
      <p>
        As a part of the functionality of the Site, you may link your account
        ...
        to your Third-Party Account, without breach by you of nay of the terms
        ...
        your Third-Party Account additional infromation to the extent you are
        notified when you link your account with the Third-Party Account.
        Depeding on the Third-Party Accounts you choose and subject to the
        ...
        unavailable or our access to such Third Party Account is terminatede by
        the third-party service provider, then Social Network Content may no
        longer be available on or through the Site. You will have the ability to
        ...
        SERICE PROVIDERS. We make no effort to review any Social Network Content
        ...
        on your mobile device or table computer solely for purposes of
        ...
        below or through your account settings (if applicable). We will attemp
      ...
      <p>
        ...
        <a
          href="https://stockupfinance.app/privacy"
          alt="Link to StockUp Privacy Policy"
        >
          https://stockupfinance.app/privacy
        </a>
      ...
      <p>
        ...
        DAMAGE, OF ANY NATURE WHATSOEVER, RESULTING FROM YOU ACCESS TO AND USE
        OF THE SITE, (3) ANY UNAUTHORIZED ACCESS TO OR USE OF OUR SECURE SERVERS
        AND/OR ANY AND ALL PERSONAL INFORMATION AND/OR FINANCIAL INFORMATION
        STORED THEREIN, (4) ANY INTERRUPTION OR CESSATIONOF TRANSMISSION TO OR
        ...
        USE YOUR BEST JUDGMENT AND EXCERCISE CAUTION WHERE APPROPRIATE.
      </p>
      ...
      <p>
        ...
        PAID, IF ANY, BY YOU TO US OR $0.00 USD. CERTAIN US STATE LAWS AND
        INTERNATIONAL LAWS DO NOT ALLOW LIMITATIONS ON IMPLIED WARRANTIES OR THE
        EXCLUSION LIMITATION OF CERTAIN DAMAGES. IF THESE LAWS APPLY TO YOU,
      ...
      <p>
        ...
        Market Blvd., Suite N 112, Sacramento, California or by telephone at
